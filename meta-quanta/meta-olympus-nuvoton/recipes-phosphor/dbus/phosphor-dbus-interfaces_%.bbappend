...
#SRC_URI:append:olympus-nuvoton = " file://0001-Add-sensor-threshold-error-items.patch"
SRC_URI:append:olympus-nuvoton = " file://0001-set-watchdog-Interval-value-to-three-minutes.patch"
#SRC_URI:append:olympus-nuvoton = " file://0005-Add-DBUS-interface-of-CPU-and-Memory-s-properties.patch"
