...
FILENAME = "BootBlockAndHeader_${PV}.bin"
...
SRC_URI = " \
    ...
    https://github.com/Nuvoton-Israel/npcm8xx-bootblock/releases/download/A35_BootBlock_${PV}/BootBlockAndHeader.bin;downloadfilename=${FILENAME};name=bin \
"
...
do_deploy () {
    ...
    install -D -m 644 ${WORKDIR}/${FILENAME} ${DEPLOYDIR}/BootBlockAndHeader.bin
}
