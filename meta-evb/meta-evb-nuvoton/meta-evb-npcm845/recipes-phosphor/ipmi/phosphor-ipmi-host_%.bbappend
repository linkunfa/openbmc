...
EXTRA_OECONF_append_evb-npcm845 = " SENSOR_YAML_GEN=${STAGING_DIR_HOST}${datadir}/evb-npcm845-yaml-config/ipmi-sensors.yaml"
EXTRA_OECONF_append_evb-npcm845 = " FRU_YAML_GEN=${STAGING_DIR_HOST}${datadir}/evb-npcm845-yaml-config/ipmi-fru-read.yaml"
EXTRA_OECONF_append_evb-npcm845 = " INVSENSOR_YAML_GEN=${STAGING_DIR_HOST}${datadir}/evb-npcm845-yaml-config/ipmi-inventory-sensors.yaml"
...
#SRC_URI_append_evb-npcm845 = " file://0003-add-oem-command-get-bios-post-code.patch"
